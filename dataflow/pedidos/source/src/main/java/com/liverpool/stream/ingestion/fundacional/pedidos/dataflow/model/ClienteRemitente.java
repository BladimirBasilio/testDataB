...
public class ClienteRemitente implements Cloneable   {
    ...
    public ClienteRemitente() {}

	public ClienteRemitente(Integer id_cliente, String primer_nombre, String segundo_nombre, String apellido_paterno,
			...
			ClienteId cliente_id, Integer id_sistema_origen, ClienteDireccion direccion) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ClienteRemitente other = (ClienteRemitente) obj;
	...
	public String toString() {
		return "ClienteRemitente [id_cliente=" + id_cliente + ", primer_nombre=" + primer_nombre + ", segundo_nombre="
				+ segundo_nombre + ", apellido_paterno=" + apellido_paterno + ", apellido_materno=" + apellido_materno
				+ ", clave_homologada=" + clave_homologada + ", operacion_crud=" + operacion_crud
				+ ", telefono_de_contacto=" + telefono_de_contacto + ", email_de_contacto=" + email_de_contacto
				+ ", cliente_id=" + cliente_id + ", id_sistema_origen=" + id_sistema_origen + ", direccion=" + direccion + "]";
	}
	...
	public Object clone() {
		try {
	        return (ClienteRemitente)super.clone();
	    } catch (Exception e) {
	        // either handle the exception or throw it
	        return new ClienteRemitente(
	        		this.id_cliente,
	        		this.primer_nombre,
	        		this.segundo_nombre,
