...
public class ClienteId   implements Cloneable {
    ...
    @Nullable private String fecha_de_actualizacion;
    @Nullable private String fecha_de_creacion;
	...
	public ClienteId(Integer id_cliente_ids, String id_origen, Integer id_cliente, Integer id_sistema_origen,
			String fecha_de_actualizacion, String fecha_de_creacion, String operacion_crud) {
		super();
	...
	public @Nullable String getFecha_de_actualizacion() {
	...
	public void setFecha_de_actualizacion(@Nullable String fecha_de_actualizacion) {
		this.fecha_de_actualizacion = fecha_de_actualizacion;
	}
	...
	public @Nullable String getFecha_de_creacion() {
	...
	public void setFecha_de_creacion(@Nullable String fecha_de_creacion) {
		this.fecha_de_creacion = fecha_de_creacion;
	}
	...
	public String toString() {
		return "ClienteId [id_cliente_ids=" + id_cliente_ids + ", id_origen=" + id_origen + ", id_cliente=" + id_cliente
				...
				+ ", fecha_de_creacion=" + fecha_de_creacion + ", operacion_crud=" + operacion_crud + "]";
	}
